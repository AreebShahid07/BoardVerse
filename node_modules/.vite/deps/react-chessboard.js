...
function $e(e3, t2, r2, n2) {
  ...
  for (let s3 = 0; s3 < i2.length; s3++) {
    ...
    if (o2 = r2 ? r2.call(n2, u2, l2, c2) : void 0, false === o2 || void 0 === o2 && u2 !== l2) return false;
  }
  return true;
}
function Ve(e3) {
...
var Gt = (e3) => Array.from(e3).map((e4) => e4.split(","));
var Qt = (e3, t2 = true, r2) => {
  ...
  return { arrows: Gt(n2), newArrow: s2, clearArrows: function() {
    o2(/* @__PURE__ */ new Set()), c2(void 0);
  }, removeArrow: (e4, t3) => {
    let r3;
    const i2 = Array.from(n2);
    for (const [n3] of i2.entries()) i2[n3][0] === e4 && i2[n3][1] === t3 && (o2((e5) => {
      const t4 = [...e5];
...
var er = (0, import_react.forwardRef)(({ animationDuration: t2 = 300, areArrowsAllowed: r2 = true, arePiecesDraggable: n2 = true, arePremovesAllowed: o2 = false, boardOrientation: s2 = "white", boardWidth: c2, children: u2, clearPremovesOnRightClick: l2 = true, customArrows: d2, customArrowColor: h2 = "rgb(255,170,0)", customBoardStyle: g2, customDarkSquareStyle: v2 = { backgroundColor: "#B58863" }, customDropSquareStyle: m2 = { boxShadow: "inset 0 0 1px 6px rgba(255,255,255,0.75)" }, customLightSquareStyle: y = { backgroundColor: "#F0D9B5" }, customPieces: b2, customPremoveDarkSquareStyle: O2 = { backgroundColor: "#A42323" }, customPremoveLightSquareStyle: w2 = { backgroundColor: "#BD2828" }, customSquare: S2 = "div", customSquareStyles: D2, dropOffBoardAction: C2 = "snapback", id: T2 = 0, isDraggablePiece: E2 = () => true, getPositionObject: I2 = () => {
...
}, onPieceDrop: R2 = () => true, onPromotionDialogOpen: A2 = () => true, onPromotionPieceSelect: q2, onSquareClick: _2 = () => {
  ...
  const [K2, X2] = (0, import_react.useState)(Kt(H2)), [G2, Q2] = (0, import_react.useState)({ removed: {}, added: {} }), [J2, Z2] = (0, import_react.useState)(void 0), [ee2, te2] = (0, import_react.useState)(F2 && !V2), [re2, ne2] = (0, import_react.useState)(null), [oe2, ie2] = (0, import_react.useState)(W2), [se2, ae2] = (0, import_react.useState)([]), ce2 = (0, import_react.useRef)(se2), [ue2, le2] = (0, import_react.useState)(), [de2, he2] = (0, import_react.useState)(Object.assign(Object.assign({}, Vt), b2)), [ge2, fe2] = (0, import_react.useState)(false), [pe2, ve2] = (0, import_react.useState)(), [me2, ye2] = (0, import_react.useState)(false);
  (0, import_react.useImperativeHandle)(Y2, () => ({ clearPremoves(e3 = true) {
    ...
    var e3, r3, n3;
    Ee2();
    const i2 = Kt(H2), s3 = function(e4, t3) {
    ...
    if (me2) X2(i2), ye2(false), o2 && Ce2(a2), pe2 && clearTimeout(pe2);
    else if (ge2) X2(i2), ye2(false), o2 && Ce2(a2);
    else {
      !function(e5) {
        let t3 = false;
        return Object.keys(Bt).forEach((r4) => {
          e5[r4] !== Bt[r4] && (t3 = true);
        }), Object.keys(e5).forEach((r4) => {
          Bt[r4] !== e5[r4] && (t3 = true);
        }), t3;
      }(i2) || void 0 === J2 ? Z2(void 0) : Z2(a2), Q2(s3), ye2(true);
      const e4 = setTimeout(() => {
  ...
  const { arrows: be2, newArrow: Oe2, clearArrows: we2, drawNewArrow: Se2, onArrowDrawEnd: De2 } = Qt(d2, r2, k2);
  function Ce2(e3) {
    if (0 === ce2.current.length) return;
  ...
  const Ie2 = { animationDuration: t2, arePiecesDraggable: n2, arePremovesAllowed: o2, boardOrientation: s2, boardWidth: c2, customArrowColor: h2, customBoardStyle: g2, customDarkSquareStyle: v2, customDropSquareStyle: m2, customLightSquareStyle: y, customPremoveDarkSquareStyle: O2, customPremoveLightSquareStyle: w2, customSquare: S2, customSquareStyles: D2, id: T2, isDraggablePiece: E2, onDragOverSquare: L2, onMouseOutSquare: P2, onMouseOverSquare: x2, onPieceClick: M2, onPieceDragBegin: N2, onPieceDragEnd: j2, onPieceDrop: R2, onPromotionDialogOpen: A2, onPromotionPieceSelect: q2, onSquareClick: _2, showBoardNotation: U2, snapToCursor: $2, promotionDialogVariant: B2, arrows: be2, newArrow: Oe2, onArrowDrawEnd: De2, chessPieces: de2, clearArrows: we2, drawNewArrow: Se2, clearCurrentRightClickDown: function() {
    ...
    if (fe2(!!n3), Z2(r3[0]), R2.length) {
      R2(e3, t3, r3) || Te2();
    } else "trash" !== C2 || t3 || delete i2[e3], delete i2[e3], i2[t3] = r3, X2(i2);
    Ee2(), I2(i2);
  }, isWaitingForAnimation: me2, lastPieceColour: J2, onRightClickDown: function(e3) {
    le2(e3);
  }, onRightClickUp: function(e3) {
    if (ue2) {
      if (ue2 === e3) return le2(void 0), l2 && Te2(false), void z2(e3);
    } else le2(void 0);
  ...
  return (0, import_jsx_runtime.jsx)(Jt.Provider, Object.assign({ value: Ie2 }, { children: u2 }));
});
function tr({ row: n2, col: o2 }) {
  const { boardOrientation: i2, boardWidth: s2, customDarkSquareStyle: a2, customLightSquareStyle: c2 } = Zt(), u2 = c2.backgroundColor, l2 = a2.backgroundColor, d2 = 0 === o2, h2 = 7 === n2;
  function g2() {
  ...
  return d2 && h2 ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("div", Object.assign({ style: Object.assign(Object.assign({ zIndex: 3, position: "absolute" }, { color: u2 }), nr(s2)) }, { children: g2() })), (0, import_jsx_runtime.jsx)("div", Object.assign({ style: Object.assign(Object.assign({ zIndex: 3, position: "absolute" }, { color: u2 }), rr(s2)) }, { children: f2() }))] }) : h2 ? (0, import_jsx_runtime.jsx)("div", Object.assign({ style: Object.assign(Object.assign({ zIndex: 3, position: "absolute" }, { color: o2 % 2 != 0 ? l2 : u2 }), rr(s2)) }, { children: f2() })) : d2 ? (0, import_jsx_runtime.jsx)("div", Object.assign({ style: Object.assign(Object.assign({ zIndex: 3, position: "absolute" }, { color: n2 % 2 == 0 ? l2 : u2 }), nr(s2)) }, { children: g2() })) : null;
}
var rr = (e3) => ({ alignSelf: "flex-end", paddingLeft: e3 / 8 - e3 / 48, fontSize: e3 / 48 });
var nr = (e3) => ({ alignSelf: "flex-start", paddingRight: e3 / 8 - e3 / 48, fontSize: e3 / 48 });
function or({ isPremovedPiece: t2 = false, piece: r2, square: n2, squares: o2 }) {
  const { animationDuration: s2, arePiecesDraggable: c2, arePremovesAllowed: u2, boardWidth: l2, chessPieces: d2, currentPosition: h2, id: g2, isDraggablePiece: f2, isWaitingForAnimation: p2, onPieceClick: v2, onPieceDragBegin: m2, onPieceDragEnd: y, positionDifferences: b2, premoves: O2 } = Zt(), [w2, S2] = (0, import_react.useState)({ opacity: 1, zIndex: 5, touchAction: "none", cursor: c2 && f2({ piece: r2, sourceSquare: n2 }) ? "-webkit-grab" : "default" }), [{ canDrag: D2, isDragging: C2 }, T2, E2] = tt(() => ({ type: "piece", item: () => (m2(r2, n2), { piece: r2, square: n2, id: g2 }), end: () => y(r2, n2), collect: (e3) => ({ canDrag: f2({ piece: r2, sourceSquare: n2 }), isDragging: !!e3.isDragging() }) }), [r2, n2, h2, g2]);
...
function ir({ square: t2, squareColor: r2, setSquares: n2, squareHasPremove: o2, children: s2 }) {
  const a2 = (0, import_react.useRef)(null), { autoPromoteToQueen: c2, boardWidth: u2, boardOrientation: l2, clearArrows: d2, currentPosition: h2, currentRightClickDown: g2, customBoardStyle: p2, customDarkSquareStyle: v2, customDropSquareStyle: m2, customLightSquareStyle: y, customPremoveDarkSquareStyle: b2, customPremoveLightSquareStyle: O2, customSquare: w2, customSquareStyles: S2, drawNewArrow: D2, handleSetPosition: C2, isWaitingForAnimation: T2, lastPieceColour: E2, onArrowDrawEnd: I2, onDragOverSquare: k2, onMouseOutSquare: L2, onMouseOverSquare: P2, onPieceDrop: x2, onPromotionDialogOpen: M2, onRightClickDown: N2, onRightClickUp: j2, onSquareClick: R2, setPromoteFromSquare: A2, setPromoteToSquare: q2, setShowPromoteDialog: _2 } = Zt(), [{ isOver: z2 }, H2] = it(() => ({ accept: "piece", drop: B2, collect: (e3) => ({ isOver: !!e3.isOver() }) }), [t2, h2, x2, T2, E2]);
  function B2(e3) {
    if (Math.abs(e3.square[0].charCodeAt(0) - t2[0].charCodeAt(0)) <= 1 && ("wP" === e3.piece && "7" === e3.square[1] && "8" === t2[1] || "bP" === e3.piece && "2" === e3.square[1] && "1" === t2[1])) if (c2) C2(e3.square, t2, "8" === t2[1] ? "wQ" : "bQ");
    else {
      M2(e3.square, t2) && (A2(e3.square), q2(t2), _2(true));
    }
    else C2(e3.square, t2, e3.piece, true);
  }
  (0, import_react.useEffect)(() => {
    if (a2.current) {
  ...
  const W2 = Object.assign(Object.assign(Object.assign(Object.assign({}, cr(t2, l2, p2)), "black" === r2 ? v2 : y), o2 && ("black" === r2 ? b2 : O2)), z2 && m2);
  return (0, import_jsx_runtime.jsx)("div", Object.assign({ ref: H2, style: W2, "data-square-color": r2, "data-square": t2, onMouseOver: (e3) => {
    ...
    e3.preventDefault();
  } }, { children: (0, import_jsx_runtime.jsx)(w2, "string" == typeof w2 ? Object.assign({ ref: a2, style: Object.assign(Object.assign(Object.assign({}, ar(u2)), sr), !o2 && (null == S2 ? void 0 : S2[t2])) }, { children: s2 }) : Object.assign({ ref: a2, square: t2, squareColor: r2, style: Object.assign(Object.assign(Object.assign({}, ar(u2)), sr), !o2 && (null == S2 ? void 0 : S2[t2])) }, { children: s2 })) }));
}
var sr = { display: "flex", justifyContent: "center" };
var ar = (e3) => ({ width: e3 / 8, height: e3 / 8 });
var cr = (e3, t2, r2) => (null == r2 ? void 0 : r2.borderRadius) ? "a1" === e3 ? "white" === t2 ? { borderBottomLeftRadius: r2.borderRadius } : { borderTopRightRadius: r2.borderRadius } : "a8" === e3 ? "white" === t2 ? { borderTopLeftRadius: r2.borderRadius } : { borderBottomRightRadius: r2.borderRadius } : "h1" === e3 ? "white" === t2 ? { borderBottomRightRadius: r2.borderRadius } : { borderTopLeftRadius: r2.borderRadius } : "h8" === e3 ? "white" === t2 ? { borderTopRightRadius: r2.borderRadius } : { borderBottomLeftRadius: r2.borderRadius } : {} : {};
function ur() {
  const [r2, n2] = (0, import_react.useState)({}), { boardOrientation: o2, boardWidth: i2, currentPosition: s2, customBoardStyle: c2, id: u2, premoves: l2, showBoardNotation: d2 } = Zt();
  return (0, import_jsx_runtime.jsx)("div", Object.assign({ "data-boardid": u2, style: Object.assign(Object.assign({}, lr(i2)), c2) }, { children: [...Array(8)].map((a2, c3) => (0, import_jsx_runtime.jsx)("div", Object.assign({ style: { display: "flex", flexWrap: "nowrap", width: i2 } }, { children: [...Array(8)].map((i3, a3) => {
    ...
    return (0, import_jsx_runtime.jsxs)(ir, Object.assign({ square: u3, squareColor: h2, setSquares: n2, squareHasPremove: !!g2 }, { children: [s2[u3] && (0, import_jsx_runtime.jsx)(or, { piece: s2[u3], square: u3, squares: r2 }), f2 && (0, import_jsx_runtime.jsx)(or, { isPremovedPiece: true, piece: f2.piece, square: u3, squares: r2 }), d2 && (0, import_jsx_runtime.jsx)(tr, { row: c3, col: a3 })] }), `${a3}${c3}`);
  }) }), c3.toString())) }));
}
var lr = (e3) => ({ cursor: "default", height: e3, width: e3 });
var dr = () => {
  const { arrows: r2, newArrow: n2, boardOrientation: o2, boardWidth: i2, customArrowColor: s2 } = Zt(), a2 = [...r2, n2].filter(Boolean);
...
function hr({ option: t2 }) {
  const [r2, n2] = (0, import_react.useState)(false), { boardWidth: o2, chessPieces: i2, customDarkSquareStyle: s2, customLightSquareStyle: c2, handleSetPosition: u2, onPromotionPieceSelect: l2, promoteFromSquare: d2, promoteToSquare: h2, promotionDialogVariant: g2 } = Zt(), f2 = () => {
    switch (t2[1]) {
      case "Q":
...
function mr() {
  ...
  }, []), o2 ? (0, import_jsx_runtime.jsxs)("div", Object.assign({ ref: n2, style: { position: "relative" } }, { children: [(0, import_jsx_runtime.jsx)(ur, {}), (0, import_jsx_runtime.jsx)(dr, {}), u2 && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("div", { onClick: () => {
    c2(false), null == a2 || a2();
  }, style: { position: "absolute", top: "0", left: "0", zIndex: "100", backgroundColor: "rgba(22,21,18,.7)", width: o2, height: o2 } }), (0, import_jsx_runtime.jsx)(gr, {})] })] })) : (0, import_jsx_runtime.jsx)(vr, {});
}
function yr() {
  const { boardWidth: t2, chessPieces: r2, id: n2, snapToCursor: o2 } = Zt(), s2 = function(e3) {
...
var br = (0, import_react.forwardRef)((r2, n2) => {
